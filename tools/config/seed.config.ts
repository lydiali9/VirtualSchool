...
export class SeedConfig {
  ...
  */
  ...
  DESIGN_CLIENT = argv['design'] || 'design';
   ...
   * @type {string}
   */
  APP_TITLE = 'UNW | Virtual Skills School';
  ...
  /**
   * The base folder of the design and non-angular source files.
   * @type {string}
   */
  DESIGN_SRC = `src/${this.DESIGN_CLIENT}`;
   ...
   * @type {string}
   */
  DESIGN_ASSETS_SRC = `${this.DESIGN_SRC}/assets`;
  ...
  /**
   * The folder of the Design Page files.
   * @type {string}
   */
  DESIGN_PAGES_SRC = `${this.DESIGN_SRC}/pages`;

  /**
   * The folder of the Design Partial files.
   * @type {string}
   */
  DESIGN_PARTIALS_SRC = `${this.DESIGN_SRC}/partials`;
  ...
  /**
   * The folder for the built Angular2 Application files, corresponding to the current environment.
   * @type {string}
   */
  APP_DEST = this.BUILD_TYPE === BUILD_TYPES.DEVELOPMENT ? this.DEV_DEST : this.PROD_DEST;

  /**
   * The folder for the built Design files, corresponding to the current environment.
   * @type {string}
   */
  DESIGN_DEST = this.BUILD_TYPE === BUILD_TYPES.DEVELOPMENT ? this.DEV_DEST : this.PROD_DEST;

  /**
   * The folder for the built Design files, corresponding to the current environment.
   * @type {string}
   */
  DESIGN_ASSETS_DEST = this.BUILD_TYPE === BUILD_TYPES.DEVELOPMENT ? `${this.DEV_DEST}/assets` : `${this.PROD_DEST}/assets`;

  /**
   * The folder for the built CSS files.
   * @type {strings}
   */
  CSS_DEST = `${this.DESIGN_DEST}/css`;

  /**
   * The folder for the built JavaScript files.
   * @type {string}
   */
  JS_DEST = `${this.DESIGN_DEST}/js`;
  ...
  /**
   * The options to pass to design javascript compilation.
   * These options are used for design dependencies, separately from Angular App.
   * Reference: https://github.com/sass/node-sass#options
   * @type {array}
   */
  DESIGN_JS_COMPONENTS = [
    'node_modules/foundation-sites/vendor/jquery/dist/jquery.js',
    'node_modules/what-input/what-input.js',
    'node_modules/foundation-sites/dist/foundation.js',
    'node_modules/slick-carousel/slick/slick.js',
    'src/design/assets/js/**/*.js',
    'src/design/assets/js/app.js'
  ];
